...
import com.yangdb.commons.task.factory.TaskFactory;

import static com.yangdb.commons.util.GenericUtils.infere;

public class LoggingTaskFactory {
    public static class Uni<T1, TResult> implements TaskFactory.Uni<T1, TResult> {
        //region Constructors
        public Uni(TaskFactory.Uni<T1, TResult> taskFactory, LoggingTask.Builder<?, ?> builder) {
        ...
        public Task<TResult, ?> getTask(T1 param1) throws Exception {
            return infere(this.builder.build(infere(this.taskFactory.getTask(param1))));
        }
        //endregion

        //region Fields
        private TaskFactory.Uni<T1, TResult> taskFactory;
        private LoggingTask.Builder<?, ?> builder;
        //endregion
    }

    public static class Bi<T1, T2, TResult> implements TaskFactory.Bi<T1, T2, TResult> {
        //region Constructors
        public Bi(TaskFactory.Bi<T1, T2, TResult> taskFactory, LoggingTask.Builder<?, ?> builder) {
            this.taskFactory = taskFactory;
            this.builder = builder;
        }
        //endregion
        ...
        public Task<TResult, ?> getTask(T1 param1, T2 param2) throws Exception {
            return infere(this.builder.build(infere(this.taskFactory.getTask(param1, param2))));
        }
        //endregion
    ...
    public static class Tri<T1, T2, T3, TResult> implements TaskFactory.Tri<T1, T2, T3, TResult> {
        //region Constructors
        public Tri(TaskFactory.Tri<T1, T2, T3, TResult> taskFactory, LoggingTask.Builder<?, ?> builder) {
            this.taskFactory = taskFactory;
            this.builder = builder;
        }
        //endregion
        ...
        public Task<TResult, ?> getTask(T1 param1, T2 param2, T3 param3) throws Exception {
            return infere(this.builder.build(infere(this.taskFactory.getTask(param1, param2, param3))));
        }
        //endregion
    ...
    public static class Quadri<T1, T2, T3, T4, TResult> implements TaskFactory.Quadri<T1, T2, T3, T4, TResult> {
        //region Constructors
        public Quadri(TaskFactory.Quadri<T1, T2, T3, T4, TResult> taskFactory, LoggingTask.Builder<?, ?> builder) {
            this.taskFactory = taskFactory;
            this.builder = builder;
        }
        //endregion
        ...
        public Task<TResult, ?> getTask(T1 param1, T2 param2, T3 param3, T4 param4) throws Exception {
            return infere(this.builder.build(infere(this.taskFactory.getTask(param1, param2, param3, param4))));
        }
        //endregion

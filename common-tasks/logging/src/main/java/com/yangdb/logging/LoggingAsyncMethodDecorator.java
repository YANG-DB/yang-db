...
public class LoggingAsyncMethodDecorator<TResult> implements MethodDecorator.Async<TResult, Void> {
    //region Constructors
    public LoggingAsyncMethodDecorator(
            Logger logger,
            Marker marker,
    ...
    private LoggingAsyncMethodDecorator() {}
    //endregion

    //region MethodDecorator Implementation
    @Override
    public CompletionStage<TResult> decorate(ThrowingSupplier<CompletionStage<TResult>> methodInvocationSupplier, MethodDecorator.ResultHandler<TResult, Void> resultHandler) throws Exception {
        ...
        try {
            ...
            CompletionStage<TResult> methodInvocationFuture = methodInvocationSupplier.get();

            return methodInvocationFuture.thenApply(methodInvocationResult -> {
    ...
    public static class Builder<TResult> {
        ...
        public Builder(Logger logger, MethodName.Value methodName) {
            this.decorator = new LoggingAsyncMethodDecorator<>();
        ...
        public Builder(LoggingAsyncMethodDecorator.Builder<TResult> other) {
            this.decorator = new LoggingAsyncMethodDecorator<>();
        ...
        public Builder<TResult> failureLevels(Iterable<LogMessage.Level> failureLevels) {
            this.decorator.successLevelsFunction = ex -> failureLevels;
            return this;
        }
        ...
        public LoggingAsyncMethodDecorator<TResult> build() {
        ...
        //region Fields
        private final LoggingAsyncMethodDecorator<TResult> decorator;
        //endregion
    }
}

 ...
 */
public class BaseAsgbuilderTest {
    ...
    public void transformQuery1ToAsgQuery() throws Exception {
        Asgbuilder asgBuilder = new BaseAsgbuilder();
        AsgQuery asgQuery = asgBuilder.transformQueryToAsgQuery(q1Obj);
        ...
        assertEquals(elementEbaseAsg3.getNext(),null);
    }

    @Test
    public void transformQuery5ToAsgQuery() throws Exception {
        Asgbuilder asgBuilder = new BaseAsgbuilder();
        AsgQuery asgQuery = asgBuilder.transformQueryToAsgQuery(q5Obj);
        assertEquals(asgQuery.getStart().geteBase().geteNum(), 0);

 ...
 * under the License.
 */
package com.kayhut.fuse.logging.reporting;
...
import com.kayhut.fuse.logging.reporting.JsonMetrics.JsonMeter;
import com.kayhut.fuse.logging.reporting.JsonMetrics.JsonMetric;
import com.kayhut.fuse.logging.reporting.JsonMetrics.JsonTimer;
import com.kayhut.fuse.logging.reporting.MetricsElasticsearchModule.BulkIndexOperationHeader;
        ...
        try {
            ...
            for (Map.Entry<String, Gauge> entry : gauges.entrySet()) {
                if (entry.getValue().getValue() != null) {
                    JsonMetric jsonMetric = new JsonMetrics.JsonGauge(name(prefix, entry.getKey()), timestamp, entry.getValue());

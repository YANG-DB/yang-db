package com.yangdb.fuse.services.controllers.languages.cypher;
...
import com.yangdb.fuse.dispatcher.query.cypher.CypherDDLTranslator;
 ...
 */
public class StandardCypherQLController implements SchemaTranslatorController {
    public static final String transformerName = "StandardCypherQLController.@transformer";

    //region Constructors
    @Inject
    public StandardCypherQLController(CypherDDLTranslator transformer, OntologyProvider provider) {
    ...
    @Override
    public ContentResponse<Ontology> translate(String ontology, String cypherDDL) {
        return Builder.<Ontology>builder(OK, NOT_FOUND)
                .data(Optional.of(this.transformer.transform(ontology, cypherDDL)))
                .compose();
    }
    ...
    //region Fields
    private CypherDDLTranslator transformer;

...
public class LoggingCypherQLController extends LoggingControllerBase<SchemaTranslatorController> implements SchemaTranslatorController {
    public static final String controllerParameter = "LoggingCypherQLController.@controller";
    public static final String loggerParameter = "LoggingCypherQLController.@logger";

    //region Constructors
    @Inject
    public LoggingCypherQLController(

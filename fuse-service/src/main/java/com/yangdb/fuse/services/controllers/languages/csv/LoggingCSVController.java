...
public class LoggingCSVController extends LoggingControllerBase<SchemaTranslatorController> implements SchemaTranslatorController {
    public static final String controllerParameter = "LoggingCSVController.@controller";
    public static final String loggerParameter = "LoggingCSVController.@logger";

    //region Constructors
    @Inject
    public LoggingCSVController(

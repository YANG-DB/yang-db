...
public class TransformerEntityType {
    ...
    public TransformerEntityType(String type, String name, List<Map<String,String>> metadataProperties) {
        this.eType = type;
        this.pattern = name;
    ...
    {
        return "EntityType [eType = "+eType+", name = "+ pattern +", properties = "+ metadataProperties +"]";
    }

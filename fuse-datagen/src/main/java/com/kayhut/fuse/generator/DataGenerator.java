...
import com.kayhut.fuse.generator.data.generation.graph.PersonsGraphGenerator;
...
public class DataGenerator {
    ...
    public static void main(String[] args) {
        ...
        List<String> dragonsIds = generateMassiveDragonsGraph(configuration);
        List<String> personsIds = generateMassivePersonsGraph(configuration);
    ...
    public static List<String> generateMassiveDragonsGraph(Configuration configuration) {
        ...
        try {
            ...
            nodesIds = massiveDragonsGraphGenerator.generateMassiveGraph();
            stopwatch.stop();
            long elapsed = stopwatch.elapsed(TimeUnit.SECONDS);
    ...
    public static List<String> generateMassivePersonsGraph(Configuration configuration) {
        List<String> nodesIds = new ArrayList<>();
        try {
            Stopwatch stopwatch = Stopwatch.createStarted();
    ...
    public static Map<Integer, List<Integer>> attachDragonsToPersons(List<Integer> dragonsIdList,
                                                                     List<Integer> personsIdList,
    ...
    public static Map<Integer, List<Integer>> attachHorsesToPersons(List<Integer> horsesIdList,
                                                                    List<Integer> personsIdList,
    ...
    private static Map<Integer, List<Integer>> attachAnimalToPersons(List<Integer> animalsIdList,
                                                                    List<Integer> personsIdList,
                                                                    double meanAnimalsPerPerson,
                                                                    double sdAnimalsPerPerson) {
        Map<Integer, List<Integer>> animalsToPersonsSet = new HashMap<>();

        //Deep Copy
        List<Integer> animalsIdsClone = new ArrayList<>();
        for (int d : animalsIdList) {
        ...
        Map<Integer, Boolean> assignedAnimals = new HashMap<>();
        ...
        for (int i = 0; i < gaussianDist.size(); i++) {
            ...
            List<Integer> selectedAnimalsIds = animalsIdsClone.subList(selectionStartIndex, selectionEndIndex);
            selectionStartIndex = selectionEndIndex;

            for (int dragonId : selectedAnimalsIds) {
                if (animalsToPersonsSet.get(personId) == null) {
                    ...
                    List<Integer> animalsPerPerson = animalsToPersonsSet.get(personId);
    ...
    public static List<Tuple2> attachDragonToKingdom(List<Integer> kingdomsIdList, List<Integer> dragonsIdList) {
        return attachEntityToKingdom(kingdomsIdList, dragonsIdList);
    }

    public static List<Tuple2> attachHorseToKingdom(List<Integer> kingdomsIdList, List<Integer> horsesIdList) {
        return attachEntityToKingdom(kingdomsIdList, horsesIdList);
    }

    public static List<Tuple2> attachGuildToKingdom(List<Integer> kingdomsIdList, List<Integer> guildsIdList) {
        return attachEntityToKingdom(kingdomsIdList, guildsIdList);
    }

    //region Private Methods

    private static List<Tuple2> attachAnimalsToKingdom(List<Integer> kingdomsIdList, List<Integer> animalsIdList) {
        return attachEntityToKingdom(kingdomsIdList, animalsIdList);
    }

    private static List<Tuple2> attachEntityToKingdom(List<Integer> kingdomsIdList, List<Integer> entitiesIdList) {

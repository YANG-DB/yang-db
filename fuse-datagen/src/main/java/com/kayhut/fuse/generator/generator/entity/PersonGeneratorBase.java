...
import com.kayhut.fuse.generator.generator.other.PropertiesGenerator;
 ...
 */
public class PersonGeneratorBase extends EntityGeneratorBase<PersonConfiguration, Person> {

    public PersonGeneratorBase(PersonConfiguration configuration) {
        super(configuration);
    }

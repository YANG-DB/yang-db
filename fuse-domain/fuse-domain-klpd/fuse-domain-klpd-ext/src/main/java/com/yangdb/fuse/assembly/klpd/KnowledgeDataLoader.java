...
import com.yangdb.fuse.assembly.klpd.load.KlpdContext;
import com.yangdb.fuse.assembly.klpd.load.KnowledgeTransformer;
...
import static com.yangdb.fuse.assembly.klpd.load.KlpdWriterContext.commit;
...
public class KnowledgeDataLoader implements GraphDataLoader {
    ...
    public long load(LogicalGraphModel root) throws JsonProcessingException {
        final KlpdContext context = transformer.transform(root);

   ...
   //endregion
    ...
    public Iterable<AsgStrategy> register() {
        return Arrays.asList(
                ...
                new ConstraintExpLowercaseTransformationAsgStrategy(Arrays.asList(KlpdRoutedSchemaProviderFactory.SchemaFields.STRING_VALUE, KlpdRoutedSchemaProviderFactory.SchemaFields.CONTENT, KlpdRoutedSchemaProviderFactory.SchemaFields.TITLE, KlpdRoutedSchemaProviderFactory.SchemaFields.DISPLAY_NAME, KlpdRoutedSchemaProviderFactory.SchemaFields.DESCRIPTION)),

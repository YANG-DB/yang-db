...
import com.yangdb.fuse.assembly.klpd.load.builder.EntityBuilder;
import com.yangdb.fuse.assembly.klpd.load.builder.RelationBuilder;
import com.yangdb.fuse.assembly.klpd.load.builder.RvalueBuilder;
import com.yangdb.fuse.assembly.klpd.load.builder.ValueBuilder;
...
public class KlpdContext {
    ...
    public void add(RvalueBuilder builder) {
        rValues.add(builder);
    }

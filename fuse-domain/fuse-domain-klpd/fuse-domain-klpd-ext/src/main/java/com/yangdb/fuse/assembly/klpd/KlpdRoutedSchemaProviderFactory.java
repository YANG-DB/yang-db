...
import static com.yangdb.fuse.assembly.klpd.KlpdRoutedSchemaProviderFactory.LogicalTypes.*;
import static com.yangdb.fuse.assembly.klpd.KlpdRoutedSchemaProviderFactory.MetadataFields.*;
import static com.yangdb.fuse.assembly.klpd.KlpdRoutedSchemaProviderFactory.SchemaFields.*;
import static com.yangdb.fuse.assembly.klpd.KlpdRoutedSchemaProviderFactory.SchemaTypes.*;
 ...
 */
public class KlpdRoutedSchemaProviderFactory implements GraphElementSchemaProviderFactory {

    //region Ontology data Types
    ...
    public static final String KLPD = "Klpd";
    ...
    @Inject
    public KlpdRoutedSchemaProviderFactory(RawSchema schema) {
        this.schema = schema;
    }

    @Override
    public GraphElementSchemaProvider get(Ontology ontology) {
        if (!ontology.getOnt().equals(KLPD)) {
            return null;
        }

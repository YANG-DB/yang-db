...
import static com.yangdb.fuse.assembly.klpd.load.builder.EntityBuilder._e;
import static com.yangdb.fuse.assembly.klpd.load.builder.RelationBuilder._rel;
import static com.yangdb.fuse.assembly.klpd.load.builder.RvalueBuilder._r;
import static com.yangdb.fuse.assembly.klpd.load.builder.ValueBuilder._v;
...
public class KnowledgeTransformer {
    ...
    private KlpdWriterContext writerContext;
    ...
    public KlpdContext transform(LogicalGraphModel graph) {
        KlpdContext context = new KlpdContext();
        this.writerContext = new KlpdWriterContext(context);
    ...
    private RelationBuilder createEdge(KlpdContext context, StatefulRange range, TransformerRelationType type, LogicalEdge edge) {
    ...
    private EntityBuilder createEntity(KlpdContext context, StatefulRange range, TransformerEntityType type, LogicalNode node) {

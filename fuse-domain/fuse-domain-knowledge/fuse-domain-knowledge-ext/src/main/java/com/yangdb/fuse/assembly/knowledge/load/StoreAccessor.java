...
/**
 * entity by Id accessor interface
 */
public interface StoreAccessor {
    Optional<Map> findEntityById(String fieldName, String id, String indexCategory, RawSchema schema);


    /**
     * default accessor
     */
    class DefaultAccessor implements StoreAccessor {
        private Client client;

        public DefaultAccessor(Client client) {
            this.client = client;
        }

        public Optional<Map> findEntityById(String fieldName, String id, String indexCategory, RawSchema schema) {

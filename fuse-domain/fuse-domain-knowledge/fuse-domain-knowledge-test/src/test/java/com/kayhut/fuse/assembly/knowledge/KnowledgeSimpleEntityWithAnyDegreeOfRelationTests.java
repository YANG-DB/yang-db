...
import com.kayhut.fuse.model.transport.cursor.FindPathTraversalCursorRequest;
    ...
    public void testSimpleEntityWithRelationFindPathInUpTo2Distance() throws IOException, InterruptedException {
        ...
        Query query = Query.Builder.instance().withName("query").withOnt(KNOWLEDGE)
                .withElements(Arrays.asList(
                        ...
                        new RelPattern(2, "relatedEntity",new com.kayhut.fuse.model.Range(0,2), R, null, 3, 0),
...
//        QueryResultBase pageData = query(fuseClient, fuseResourceInfo, query);
    ...
    @Test
    @Ignore("todo fix this test - last condition is duplicated inside the rel pattern")
    public void testSimpleEntityWithRelationFindPathInUpTo3Distance() throws IOException, InterruptedException {
        ...
        Query query = Query.Builder.instance().withName("query").withOnt(KNOWLEDGE)
                .withElements(Arrays.asList(
                        ...
                        new RelPattern(4, "relatedEntity",new com.kayhut.fuse.model.Range(0,3), R, null, 5, 0),
                        new ETyped(5, "Target", "Entity", 6, 0),
...
//        QueryResultBase pageData = query(fuseClient, fuseResourceInfo, query);
    ...
    @Test
    @Ignore("todo fix this test - One of the plans is empty")

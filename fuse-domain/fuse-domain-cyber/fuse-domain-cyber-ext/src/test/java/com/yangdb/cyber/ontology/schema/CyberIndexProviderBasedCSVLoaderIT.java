...
//        setUpInternal();//remove when running test in standalone mode
    }
    ...
    public void testLoadTraces() throws IOException, URISyntaxException {
        ...
        CSVTransformer transformer = new CSVTransformer(config, ontologyProvider, providerFactory, schema, idGeneratorDriver);

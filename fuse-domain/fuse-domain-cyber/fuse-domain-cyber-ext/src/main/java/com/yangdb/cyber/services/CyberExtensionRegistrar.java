...
public class CyberExtensionRegistrar extends AppControllerRegistrarBase<CyberExtensionQueryController> {

    //region Constructors
    public CyberExtensionRegistrar() {
        super(CyberExtensionQueryController.class);
    }
    //endregion

package com.yangdb.cyber.services;
...
import com.yangdb.cyber.driver.ExtensionQueryDriver;
import org.apache.tinkerpop.gremlin.process.traversal.dsl.graph.GraphTraversal;

import java.util.Optional;

public class CyberExtensionQueryController implements QueryController<QueryController, ExtensionQueryDriver> {
    ...
    //region Constructors
    @Inject
    public CyberExtensionQueryController(

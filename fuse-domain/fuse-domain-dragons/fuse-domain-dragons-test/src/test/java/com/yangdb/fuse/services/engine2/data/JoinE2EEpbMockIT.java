...
import com.yangdb.fuse.services.engine2.JoinE2EEpbMockTestSuite;
...
public class JoinE2EEpbMockIT implements BaseITMarker {
    ...
    private AssignmentsQueryResult dragonFireDragonX3Results() throws ParseException {
        ...
        Entity entityB = Entity.Builder.instance()
                ...
                .withProperties(Arrays.asList(
                        new com.yangdb.fuse.model.results.Property(NAME.type, "raw", DRAGON.name + 7),
                        new com.yangdb.fuse.model.results.Property(BIRTH_DATE.type, "raw", sdf.format(new Date(birthDateValueFunction.apply(7))))))
                .build();
        ...
        Entity entityC = Entity.Builder.instance()
                ...
                .withEType($ont.eType$(DRAGON.name))
                .withProperties(Arrays.asList(
                        new com.yangdb.fuse.model.results.Property(NAME.type, "raw", DRAGON.name + 8),
                        new com.yangdb.fuse.model.results.Property(BIRTH_DATE.type, "raw", sdf.format(new Date(birthDateValueFunction.apply(8))))))
                .build();
        ...
        Entity entityD = Entity.Builder.instance()
                ...
                .withEType($ont.eType$(DRAGON.name))
                .withProperties(Arrays.asList(
                        new com.yangdb.fuse.model.results.Property(NAME.type, "raw", DRAGON.name + 6),
                        new com.yangdb.fuse.model.results.Property(BIRTH_DATE.type, "raw", sdf.format(new Date(birthDateValueFunction.apply(6))))))
                .build();
        ...
        for(int i = 0;i<6;i++){
            Entity entityA = Entity.Builder.instance()
                    ...
                    .withEType($ont.eType$(DRAGON.name))
                    .withProperties(Arrays.asList(
                            new com.yangdb.fuse.model.results.Property(NAME.type, "raw", DRAGON.name + i),
                            new com.yangdb.fuse.model.results.Property(BIRTH_DATE.type, "raw", sdf.format(new Date(birthDateValueFunction.apply(i))))))
                    .build();
    ...
    private AssignmentsQueryResult dragonFireDragonX2Results() throws ParseException {
        ...
        Entity entityA = Entity.Builder.instance()
                ...
                .withEType($ont.eType$(DRAGON.name))
                .withProperties(Arrays.asList(
                        new com.yangdb.fuse.model.results.Property(NAME.type, "raw", DRAGON.name + 4),
                        new com.yangdb.fuse.model.results.Property(BIRTH_DATE.type, "raw", sdf.format(new Date(birthDateValueFunction.apply(4))))))
                .build();
        ...
        Entity entityC = Entity.Builder.instance()
                ...
                .withEType($ont.eType$(DRAGON.name))
                .withProperties(Arrays.asList(
                        new com.yangdb.fuse.model.results.Property(NAME.type, "raw", DRAGON.name + 9),
                        new com.yangdb.fuse.model.results.Property(BIRTH_DATE.type, "raw", sdf.format(new Date(birthDateValueFunction.apply(9))))))
                .build();

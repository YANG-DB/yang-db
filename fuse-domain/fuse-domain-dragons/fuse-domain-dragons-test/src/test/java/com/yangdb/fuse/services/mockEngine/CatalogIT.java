        ...
        given()
                ...
                .body(new TestUtils.ContentMatcher(o -> {
                    try {
                        ContentResponse contentResponse = new ObjectMapper().readValue(o.toString(), ContentResponse.class);
                        String result = new ObjectMapper().writeValueAsString(contentResponse.getData());
                        Assert.assertEquals("[{\"ont\":\"Dragons\",\"directives\":[],\"entityTypes\":[{\"idField\":\"id\",\"eType\":\"Person\",\"name\":\"Person\",\"properties\":[\"id\",\"firstName\",\"lastName\",\"gender\",\"birthDate\",\"deathDate\",\"height\",\"name\"]},{\"idField\":\"id\",\"eType\":\"Horse\",\"name\":\"Horse\",\"properties\":[\"id\",\"name\",\"weight\",\"maxSpeed\",\"distance\"]},{\"idField\":\"id\",\"eType\":\"Dragon\",\"name\":\"Dragon\",\"properties\":[\"id\",\"name\",\"birthDate\",\"power\",\"gender\",\"color\"]},{\"idField\":\"id\",\"eType\":\"Kingdom\",\"name\":\"Kingdom\",\"properties\":[\"id\",\"name\",\"king\",\"queen\",\"independenceDay\",\"funds\"]},{\"idField\":\"id\",\"eType\":\"Guild\",\"name\":\"Guild\",\"properties\":[\"id\",\"name\",\"description\",\"iconId\",\"url\",\"establishDate\"]}],\"relationshipTypes\":[{\"idField\":\"id\",\"rType\":\"own\",\"name\":\"own\",\"directional\":true,\"ePairs\":[{\"eTypeA\":\"Person\",\"sideAIdField\":\"entityA.id\",\"eTypeB\":\"Dragon\",\"sideBIdField\":\"entityB.id\"},{\"eTypeA\":\"Person\",\"sideAIdField\":\"entityA.id\",\"eTypeB\":\"Horse\",\"sideBIdField\":\"entityB.id\"}],\"properties\":[\"id\",\"startDate\",\"endDate\"]},{\"idField\":\"id\",\"rType\":\"know\",\"name\":\"know\",\"directional\":true,\"ePairs\":[{\"eTypeA\":\"Person\",\"sideAIdField\":\"entityA.id\",\"eTypeB\":\"Person\",\"sideBIdField\":\"entityB.id\"}],\"properties\":[\"id\",\"startDate\"]},{\"idField\":\"id\",\"rType\":\"memberOf\",\"name\":\"memberOf\",\"directional\":true,\"ePairs\":[{\"eTypeA\":\"Person\",\"sideAIdField\":\"entityA.id\",\"eTypeB\":\"Guild\",\"sideBIdField\":\"entityB.id\"}],\"properties\":[\"id\",\"startDate\",\"endDate\"]},{\"idField\":\"id\",\"rType\":\"fire\",\"name\":\"fire\",\"directional\":true,\"ePairs\":[{\"eTypeA\":\"Dragon\",\"sideAIdField\":\"entityA.id\",\"eTypeB\":\"Dragon\",\"sideBIdField\":\"entityB.id\"}],\"properties\":[\"id\",\"date\",\"temperature\"]},{\"idField\":\"id\",\"rType\":\"freeze\",\"name\":\"freeze\",\"directional\":true,\"ePairs\":[{\"eTypeA\":\"Dragon\",\"sideAIdField\":\"entityA.id\",\"eTypeB\":\"Dragon\",\"sideBIdField\":\"entityB.id\"}],\"properties\":[\"id\",\"startDate\",\"endDate\"]},{\"idField\":\"id\",\"rType\":\"originatedIn\",\"name\":\"originatedIn\",\"directional\":true,\"ePairs\":[{\"eTypeA\":\"Dragon\",\"sideAIdField\":\"entityA.id\",\"eTypeB\":\"Kingdom\",\"sideBIdField\":\"entityB.id\"}],\"properties\":[\"id\",\"startDate\"]},{\"idField\":\"id\",\"rType\":\"subjectOf\",\"name\":\"subjectOf\",\"directional\":true,\"ePairs\":[{\"eTypeA\":\"Person\",\"sideAIdField\":\"entityA.id\",\"eTypeB\":\"Kingdom\",\"sideBIdField\":\"entityB.id\"}],\"properties\":[\"id\",\"startDate\"]},{\"idField\":\"id\",\"rType\":\"registeredIn\",\"name\":\"registeredIn\",\"directional\":true,\"ePairs\":[{\"eTypeA\":\"Guild\",\"sideAIdField\":\"entityA.id\",\"eTypeB\":\"Kingdom\",\"sideBIdField\":\"entityB.id\"},{\"eTypeA\":\"Dragon\",\"sideAIdField\":\"entityA.id\",\"eTypeB\":\"Guild\",\"sideBIdField\":\"entityB.id\"},{\"eTypeA\":\"Horse\",\"sideAIdField\":\"entityA.id\",\"eTypeB\":\"Guild\",\"sideBIdField\":\"entityB.id\"}],\"properties\":[\"id\",\"startDate\"]}],\"properties\":[{\"pType\":\"id\",\"name\":\"id\",\"type\":\"string\"},{\"pType\":\"firstName\",\"name\":\"firstName\",\"type\":\"string\"},{\"pType\":\"lastName\",\"name\":\"lastName\",\"type\":\"string\"},{\"pType\":\"gender\",\"name\":\"gender\",\"type\":\"TYPE_Gender\"},{\"pType\":\"birthDate\",\"name\":\"birthDate\",\"type\":\"date\"},{\"pType\":\"deathDate\",\"name\":\"deathDate\",\"type\":\"string\"},{\"pType\":\"name\",\"name\":\"name\",\"type\":\"string\"},{\"pType\":\"height\",\"name\":\"height\",\"type\":\"int\"},{\"pType\":\"weight\",\"name\":\"weight\",\"type\":\"int\"},{\"pType\":\"maxSpeed\",\"name\":\"maxSpeed\",\"type\":\"int\"},{\"pType\":\"distance\",\"name\":\"distance\",\"type\":\"int\"},{\"pType\":\"establishDate\",\"name\":\"establishDate\",\"type\":\"date\"},{\"pType\":\"description\",\"name\":\"description\",\"type\":\"string\"},{\"pType\":\"iconId\",\"name\":\"iconId\",\"type\":\"string\"},{\"pType\":\"url\",\"name\":\"url\",\"type\":\"string\"},{\"pType\":\"king\",\"name\":\"king\",\"type\":\"string\"},{\"pType\":\"queen\",\"name\":\"queen\",\"type\":\"string\"},{\"pType\":\"independenceDay\",\"name\":\"independenceDay\",\"type\":\"string\"},{\"pType\":\"funds\",\"name\":\"funds\",\"type\":\"float\"},{\"pType\":\"color\",\"name\":\"color\",\"type\":\"TYPE_Color\"},{\"pType\":\"date\",\"name\":\"date\",\"type\":\"date\"},{\"pType\":\"startDate\",\"name\":\"startDate\",\"type\":\"date\"},{\"pType\":\"endDate\",\"name\":\"endDate\",\"type\":\"date\"},{\"pType\":\"temperature\",\"name\":\"temperature\",\"type\":\"int\"},{\"pType\":\"timestamp\",\"name\":\"timestamp\",\"type\":\"date\"},{\"pType\":\"power\",\"name\":\"power\",\"type\":\"int\"},{\"pType\":\"id\",\"name\":\"id\",\"type\":\"string\"},{\"pType\":\"type\",\"name\":\"type\",\"type\":\"string\"}],\"enumeratedTypes\":[{\"eType\":\"TYPE_Gender\",\"values\":[{\"val\":0,\"name\":\"MALE\"},{\"val\":1,\"name\":\"FEMALE\"},{\"val\":2,\"name\":\"OTHER\"}]},{\"eType\":\"TYPE_Color\",\"values\":[{\"val\":0,\"name\":\"RED\"},{\"val\":1,\"name\":\"BLUE\"},{\"val\":2,\"name\":\"GREEN\"},{\"val\":3,\"name\":\"YELLOW\"}]}],\"compositeTypes\":[]}]",result);

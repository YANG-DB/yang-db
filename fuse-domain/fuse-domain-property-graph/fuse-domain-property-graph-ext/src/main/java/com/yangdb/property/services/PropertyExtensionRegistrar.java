...
public class PropertyExtensionRegistrar extends AppControllerRegistrarBase<PropertyExtensionQueryController> {

    //region Constructors
    public PropertyExtensionRegistrar() {
        super(PropertyExtensionQueryController.class);
    }
    //endregion

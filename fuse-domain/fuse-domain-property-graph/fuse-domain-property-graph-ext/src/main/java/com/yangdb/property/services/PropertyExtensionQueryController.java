package com.yangdb.property.services;
...
import com.yangdb.property.driver.ExtensionQueryDriver;
import org.apache.tinkerpop.gremlin.process.traversal.dsl.graph.GraphTraversal;

import java.util.Optional;

public class PropertyExtensionQueryController implements QueryController<QueryController, ExtensionQueryDriver> {
    ...
    //region Constructors
    @Inject
    public PropertyExtensionQueryController(

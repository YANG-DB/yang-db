package com.yangdb.property.schema;
 ...
 */
public class PropertyOntologyGraphLayoutProviderFactory implements GraphLayoutProviderFactory {

    public static final String STRING = "string";

    //region Constructors
    public PropertyOntologyGraphLayoutProviderFactory() throws IOException {
        this("DragonsGraphLayoutProviderFactory.json");
    }

    @Inject
    public PropertyOntologyGraphLayoutProviderFactory(String configFile) throws IOException {
        this.graphLayoutProviders = new HashMap<>();
        String conf = readJsonFile("schema/" + configFile);
        this.graphLayoutProviders.put("Property", (edgeType, property) -> {
            try {

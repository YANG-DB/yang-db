...
public class InnerQueryCursor implements Cursor {
    ...
    //region Constructors
    public InnerQueryCursor(PathsTraversalCursor innerCursor, CreateHierarchyFlattenCursorRequest cursorRequest) {
    ...
    private CreateHierarchyFlattenCursorRequest cursorRequest;

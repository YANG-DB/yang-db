...
public class PersistantNodeStatusResource implements NodeStatusResource {
    ...
    private Map<String, Object> buildQueryResource(String id, Map hit) throws IOException {
        final String name = hit.get(NODE).toString();
        final String updateTime = hit.get(UPDATE_TIME).toString();
        return new HashMap<>();
    }

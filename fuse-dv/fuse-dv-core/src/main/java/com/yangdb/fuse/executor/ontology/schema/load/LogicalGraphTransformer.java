 ...
 */
public class LogicalGraphTransformer implements DataTransformer<DataTransformerContext<LogicalGraphModel>, LogicalGraphModel> {
    ...
    @Inject
    public LogicalGraphTransformer(Config config, OntologyProvider ontology, IndexProviderIfc indexProvider, RawSchema schema, IdGeneratorDriver<Range> idGenerator, Client client) {

...
public class Connection {
    ...
    public Connection(StreamInput in, Map<Vertex.VertexId, Vertex> vertices) throws IOException {
        from = vertices.get(new Vertex.VertexId(in.readString(), in.readString()));
        to = vertices.get(new Vertex.VertexId(in.readString(), in.readString()));
    ...
    public void toXContent(XContentBuilder builder, Params params, ObjectIntHashMap<Vertex> vertexNumbers) throws IOException {
    ...
    public static class UnresolvedConnection {
        ...
        public static UnresolvedConnection fromXContent(XContentParser parser) throws IOException {

...
import static com.yangdb.fuse.epb.plan.estimation.pattern.Pattern.*;
    ...
    public PlanWithCost<Plan, PlanDetailedCost> estimate(
        ...
        for (Pattern regexPattern : supportedPattern) {
            ...
            if (matcher.find()) {
                ...
                com.yangdb.fuse.epb.plan.estimation.pattern.Pattern pattern = buildPattern(regexPattern, patternParts, plan);

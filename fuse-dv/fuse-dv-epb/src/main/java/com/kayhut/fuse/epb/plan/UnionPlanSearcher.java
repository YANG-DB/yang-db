...
public class UnionPlanSearcher implements PlanSearcher<Plan, PlanDetailedCost, AsgQuery> {
    ...
    @Inject
    public UnionPlanSearcher(@Named(bottomUpPlanSearcher) PlanSearcher<Plan, PlanDetailedCost, AsgQuery> mainPlanSearcher) {
        this.mainPlanSearcher = mainPlanSearcher;
        this.splitQueryTransformer = new AsgUnionSplitQueryTransformer();
    }

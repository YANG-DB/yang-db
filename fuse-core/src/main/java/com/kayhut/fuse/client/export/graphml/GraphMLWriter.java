...
public final class GraphMLWriter implements GraphWriter {
    ...
    public static final class Builder implements WriterBuilder<GraphMLWriter> {
         ...
         * {@link GraphMLTokens#DEFAULT_GRAPHML_SCHEMA_LOCATION}.
         */
         ...
         * The value of {@link Edge#label()} is written as a data element on the edge
         ...
         * The value of {@link Vertex#label()} is written as a data element on the

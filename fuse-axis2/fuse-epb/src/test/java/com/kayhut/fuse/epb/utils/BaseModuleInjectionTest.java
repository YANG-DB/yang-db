...
public abstract class BaseModuleInjectionTest {
     ...
     * @param fileName
     */
    public BaseModuleInjectionTest(String fileName) {
    ...
    /**
     * init injector via array of modules instances
     * @param modules
     */
    public BaseModuleInjectionTest(ModuleBase[] modules) {
        init(modules);
    }

    private void init(ModuleBase[] modules) {

        ...
        binder.install(new PrivateModule() {
            ...
            protected void configure() {
                this.bind(new TypeLiteral<PlanExtensionStrategy<Plan, AsgQuery>>(){})
                        ...
                        .to(planExtensionStrategy()).asEagerSingleton();
                this.bindConstant().annotatedWith(named(PlanTracer.ExtensionStrategy.Provider.planExtensionStrategyNameParameter)).to(M1DfsRedundantPlanExtensionStrategy.class.getSimpleName());
                this.bind(new TypeLiteral<PlanExtensionStrategy<Plan, AsgQuery>>(){})
        ...
        binder.install(new PrivateModule() {
            ...
            protected void configure() {
                this.bind(new TypeLiteral<PlanValidator<Plan, AsgQuery>>(){})
                        ...
                        .to(planValidator()).asEagerSingleton();

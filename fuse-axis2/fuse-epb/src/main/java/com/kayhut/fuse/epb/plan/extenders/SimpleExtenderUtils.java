...
public class SimpleExtenderUtils {
     ...
     * "unhandled" parts
     */
    public static <C> Tuple2<List<AsgEBase>, Map<Integer, AsgEBase>> removeHandledQueryParts(Plan plan, Map<Integer, AsgEBase> queryParts) {
    ...
    public static <C> boolean checkIfPlanIsComplete(Plan plan, AsgQuery query){

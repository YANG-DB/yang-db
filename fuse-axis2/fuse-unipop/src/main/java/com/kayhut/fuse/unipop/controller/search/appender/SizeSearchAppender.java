 ...
 */
public class SizeSearchAppender implements SearchAppender<PromiseElementControllerContext> {
    //region Constructors
    ...
    @Override
    public boolean append(SearchBuilder searchBuilder, PromiseElementControllerContext context) {

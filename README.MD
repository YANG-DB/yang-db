...
### ⚙️ WhoAmI ?:
- **What's Your Name ?**: [Lior Perry](https://www.linkedin.com/in/lior-perry-yang-db/) 😊, YANG-DB stands for YetAnotherNonNativeGraph-DB 
- **Interests**: OpenTelemetry , Query Languages , Cloud-native architectures ☁️, Machine Learning 🎓, Graph DB
- **CurrentlyWorkingOn**: `source =` [OpenSearch](https://opensearch.org/) | `where "coding" contains` [ [PPL on Spark](https://github.com/opensearch-project/opensearch-spark) | [OpenTelemetry On OpenSearch](https://github.com/opensearch-project/opentelemetry-demo)| [OpenSearch Observability Catalog](https://github.com/opensearch-project/opensearch-catalog)]

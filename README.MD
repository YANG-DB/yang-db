...
- **CurrentlyWorkingOn**: [OpenSearch](https://opensearch.org/) 
    - [PPL on Spark](https://github.com/opensearch-project/opensearch-spark)
    - [OpenTelemetry On OpenSearch](https://github.com/opensearch-project/opentelemetry-demo)
